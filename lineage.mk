# Release name
PRODUCT_RELEASE_NAME := sunset2

# Inherit some common CM stuff.
$(call inherit-product, vendor/cm/config/common_full_phone.mk)

# Inherit device configuration
$(call inherit-product, device/wiko/sunset2/device_sunset2.mk)
...
PRODUCT_DEVICE := sunset2
PRODUCT_NAME := lineage_sunset2
PRODUCT_BRAND := Wiko
PRODUCT_MODEL := Sunset 2
